...
public enum PossibleSteps {
	...
	TODO_ADD_DESCRIPTION, TODO_ADD_PRIORITY, TODO_ADD_DATE, TODO_EDIT_NAME, EVENT_ADD_DESCRIPTION, TODO_SHOW_SORTED, ADD_EVENT_TO_GROUP , 
	REMOVE_EVENT_FROM_GROUP, ADD_EVENT_TO_USER, REMOVE_EVENT_FROM_USER, EDIT_USER, ADD_TODO_TO_GROUP, REMOVE_TODO_FROM_GROUP, REMOVE_TODO_FROM_USER, ADD_TODO_TO_USER
