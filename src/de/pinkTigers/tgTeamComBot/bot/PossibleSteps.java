...
public enum PossibleSteps {
	...
	WAITING_FOR_EVENT_NAME, ADD_INFO_TO_EVENT, EVENT_ADD_DESCRIPTION, EVENT_ADD_LOCATION, EVENT_ADD_DATE, WAITING_FOR_EVENT_NAME2,
	WAITING_FOR_EVENT_NAME3, EVENT_EDIT_NAME
}
